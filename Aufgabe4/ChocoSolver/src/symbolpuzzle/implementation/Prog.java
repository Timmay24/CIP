...
public class Prog {
    ...
    public static void solve() {
        ...
        // Print symbol values
        System.out.println("A = " + s.getVar(A).getVal() + ", " + "B = " + s.getVar(B).getVal() + ", " + "C = " + s.getVar(C).getVal() + ", " + "E = " + s.getVar(E).getVal() + ", " + "F = " + s.getVar(F).getVal() + ", " + "G = " + s.getVar(G).getVal() + ", " + "I = " + s.getVar(I).getVal() + ", " + "K = " + s.getVar(K).getVal());
    }
